...
Object.assign(registry, {
  ...
  dema:   require('./src/moving-averages/dema.js'),
  tema:   require('./src/moving-averages/tema.js'),
  trima:  require('./src/moving-averages/trima.js'),
  t3:     require('./src/moving-averages/t3.js'),
  zlema:  require('./src/moving-averages/zlema.js'),
  vidya:  require('./src/moving-averages/vidya.js'),
  ...
  trix:           require('./src/indicators/trix.js'),
  adl:            require('./src/indicators/adl.js'),
  cci:            require('./src/indicators/cci.js'),
  pdm:            require('./src/indicators/pdm.js'),
  mdm:            require('./src/indicators/mdm.js'),
  pdi:            require('./src/indicators/pdi.js'),
  mdi:            require('./src/indicators/mdi.js'),
  dx:             require('./src/indicators/dx.js'),
  adx:            require('./src/indicators/adx.js'),
  adxr:           require('./src/indicators/adxr.js'),
  stoch_rsi:      require('./src/indicators/stoch-rsi.js'),
  ppo:            require('./src/indicators/ppo.js'),
  apo:            require('./src/indicators/apo.js'),
  cmf:            require('./src/indicators/cmf.js'),
  nvi:            require('./src/indicators/nvi.js'),
  pvi:            require('./src/indicators/pvi.js'),
  emv:            require('./src/indicators/emv.js'),
  natr:           require('./src/indicators/natr.js'),
  dpo:            require('./src/indicators/dpo.js'),
  mass:           require('./src/indicators/mass.js'),
  ulcer:          require('./src/indicators/ulcer.js'),
  vortex:         require('./src/indicators/vortex.js'),
  kdj:            require('./src/indicators/kdj.js'),
  ...
  ult:         require('./src/oscillators/ult.js'),
  kvo:         require('./src/oscillators/kvo.js'),
  ...
  std_series:      require('./src/statistics/std_series.js'),
  lr_slope:        require('./src/statistics/lr-slope.js'),
  lr_intercept:    require('./src/statistics/lr-intercept.js'),
  lr_angle:        require('./src/statistics/lr-angle.js'),
  tsf:             require('./src/statistics/tsf.js'),
