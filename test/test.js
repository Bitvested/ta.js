...
ta.log([5, 14, 18, 28, 68, 103]).then((log) => { try { assert.deepEqual(log, [1.6094379124341003, 2.6390573296152584, 2.8903717578961645, 3.332204510175204, 4.219507705176107, 4.634728988229636]); } catch(e) { console.error("Test failed @log \n"); } });
ta.exp([1.6, 2.63, 2.89, 3.33, 4.22, 4.63]).then((exp) => { try { assert.deepEqual(exp, [4.953032424395115, 13.873769902129904,17.993309601550315, 27.938341703236507, 68.03348428941965, 102.51406411049345]); } catch(e) { console.error("Test failed @exp \n"); } });
ta.halftrend([[100,97,90],[101,98,94],[103,96,92],[106,100,95],[110,101,100],[112,110,105],[110,100,90],[103,100,97],[95,90,85],[94,80,80],[90,82,81],[85,80,70]], 6, 3, 2).then((half) => { try { assert.deepEqual(half, [[115.13773148148148, 105, 94.86226851851852, 'long'], [100.77674897119341, 90, 79.22325102880659, 'long'], [116.32021604938272, 105, 93.67978395061728, 'long'], [101.10018004115227, 90, 78.89981995884773, 'long'], [116.2485853909465, 105, 93.7514146090535, 'long'], [99.76787551440329, 90, 80.23212448559671, 'long']]); } catch(e) { console.error("Test failed @halftrend \n"); } });
